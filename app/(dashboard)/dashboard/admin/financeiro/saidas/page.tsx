...
const SaidasPage = memo(function SaidasPage() {
  ...
  const { data, isLoading } = useWithdrawalsFinancial(filters, isAdmin)
  const { data: stats } = useWithdrawalsStatsFinancial('hoje', isAdmin)
    ...
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1">
          <h1 className="text-xl font-semibold text-gray-900">Saídas</h1>
          <p className="text-sm text-gray-600">
            Visualize todos os saques da plataforma
          </p>
        </div>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-600">Total Saques</p>
                <p className="text-2xl font-bold text-red-600">
                  {stats.data.total_saques}
                </p>
              </div>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-lg font-bold text-gray-900 truncate">
                  {formatCurrencyBRL(stats.data.lucro_saques)}
                </p>
              </div>
                  ...
                  {isLoading ? (
                    ...
                    processedData.items.map((saque) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-3 text-sm text-gray-600">
                          {format(new Date(saque.data), 'dd/MM/yyyy HH:mm')}
                        </td>
                      </tr>
                    ))
                  )}
