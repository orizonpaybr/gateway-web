...
import { Copy, CheckCircle, RefreshCw, X, Loader2 } from 'lucide-react'
...
export const PixDepositModal = memo(function PixDepositModal({
  isOpen,
  onClose,
  minAmount = 1,
  initialAmount = '',
  ...
  // Renderizar QR Code
  const renderQRCode = () => {
    if (!depositData?.data) return null
        ...
        {isPaid ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex gap-3">
            ...
            <div className="text-sm text-green-800">
              ...
              <p className="mt-1">
                Seu depósito de {formatCurrencyBRL(depositAmount)} foi creditado
                com sucesso.
              </p>
            </div>
          </div>
