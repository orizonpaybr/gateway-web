...
import { Manager, AdminUser } from '@/lib/api'
...
export const ManagerClientsModal = memo(function ManagerClientsModal({
  open,
  onClose,
  manager,
  clients,
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            {isLoading ? (
              <div className="h-8 w-12 bg-blue-100 animate-pulse rounded"></div>
            ) : (
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            {isLoading ? (
              <div className="h-8 w-20 bg-green-100 animate-pulse rounded"></div>
            ) : (
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            ...
            {isLoading ? (
              <div className="h-8 w-12 bg-purple-100 animate-pulse rounded"></div>
            ) : (
